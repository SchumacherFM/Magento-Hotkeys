...
//        },
        ...
        _systemConfigKeyChecker: function () {
            var
                $system_hotkeys_key_main_menu = $('system_hotkeys_key_main_menu'),
                self = this,
                _keycode_dictionary = {
                    16: "shift",
                    17: "ctrl",
                ...
                _isFirst = true;
            if (!$system_hotkeys_key_main_menu) {
                return self;
            }

            $system_hotkeys_key_main_menu
